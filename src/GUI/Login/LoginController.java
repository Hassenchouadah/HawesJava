        ...
        if (email.isEmpty() || pwd.isEmpty()) {
            ...
            if (output == "success") {
                if (currentUser.getRole().equals("Admin")) {
                    ...
                    stageprofil.setScene(new Scene(root, 750, 500));
                    stageprofil.show();
                } else if (currentUser.getRole().equals("Chef d'agence")) {
                    Stage stage = (Stage) txtpassword.getScene().getWindow();
                    stage.close();
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("Chef_Agence.fxml"));
                    Parent root = loader.load();
                    Stage stageprofil = new Stage();
                    stageprofil.setScene(new Scene(root, 750, 500));
                    stageprofil.show();
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("Interfacechauffeur.fxml"));
